  ...
  return (
    <div className="container mx-auto pt-5 md:pt-[20vh]">
      ...
      <TypographyP className="text-[#6B6969] max-w-screen-xl text-center mx-auto">
        ...
        especially those who cannot afford materials and drugs for treatment and
        immediate help and empowering young girls, out-of-school girl children
        and unskilled young women reducing marginalization of the girl child in
        our community.
      </TypographyP>
      <div className="flex items-center justify-center w-full mt-8 md:mt-12">
        <Image
          ...
          width={70}
          height={150}
          className="w-[30px] md:w-[50px] h-[50px] md:h-[100px]"
        />
      </div>
